...
if !errorlevel! neq 0 (
	...
	echo Hint: If Git says "unmerged files", run 'git merge --abort' in your terminal to reset.&echo Hint: If it is an actual conflict, resolve the file markers (usually be removing part between <<HEAD and ==) and use Git-Push.
) else (
